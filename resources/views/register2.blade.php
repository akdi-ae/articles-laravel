...
<br>
      ...
      <form action="{{ route('register2') }}" method="POST" class="space-y-5">
                    @csrf
            ...
            @csrf
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-success btn-block">{{ __('Regis')}}</button>
                        </div>
                    </div>
                </form>
            ...
            <a href="{{ route('login2') }}" class="text-indigo-600 hover:underline font-medium">{{ __("Vhod") }}</a>
        </p>
            </div>
        </div>
    </div>
